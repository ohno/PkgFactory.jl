...
[![license](https://img.shields.io/github/license/{{{OWNER}}}/{{{PKG}}}.jl?label=license)](LICENSE)
...
- User Guide: https://{{{OWNER}}}.github.io/{{{PKG}}}.jl/dev/user
- Developer Guide: https://{{{OWNER}}}.github.io/{{{PKG}}}.jl/dev/developer
